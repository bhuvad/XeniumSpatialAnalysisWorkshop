...
Below we compare the malignant (cancer) cells from region 2 (invasive) against those from region 5 (DCIS). Investigating and visialising the top genes shows that [DHRS](https://www.genecards.org/cgi-bin/carddisp.pl?gene=DHRS) and [MUC6](https://www.genecards.org/cgi-bin/carddisp.pl?gene=MUC6) are up-regulated in invasive cancer cells while [GATA3](https://www.genecards.org/cgi-bin/carddisp.pl?gene=GATA3) and [FLNB](https://www.genecards.org/cgi-bin/carddisp.pl?gene=FLNB) are moderately up-regulated in DCIS cancer cells.
...
Next we compare the fibroblasts from region 6 (stroma) against those from region 3 (tumour-adjacent). Investigating and visialising the top genes shows that [LUM](https://www.genecards.org/cgi-bin/carddisp.pl?gene=LUM) and [POSTN](https://www.genecards.org/cgi-bin/carddisp.pl?gene=POSTN) are up-regulated in stromal fibroblasts while [MMP11](https://www.genecards.org/cgi-bin/carddisp.pl?gene=MMP11) and [AQP1](https://www.genecards.org/cgi-bin/carddisp.pl?gene=AQP1) are up-regulated in the tumour-adjacent fibroblasts.
