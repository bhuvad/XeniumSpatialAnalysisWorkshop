...
![Full IDC](inst/extdata/full_tissue.png)
...
```{r}
# t-SNE plot
p1 = plotDR(idc, dimred = "TSNE", colour = sum, alpha = 0.75) +
...
```{r}
# t-SNE plot
p1 = plotDR(idc, dimred = "TSNE", colour = detected, alpha = 0.75) +
  scale_colour_viridis_c(option = "F") +
  labs(x = "TSNE1", y = "TSNE2") +
  theme(legend.position = "bottom")
# spatial plot
...
```{r}
# t-SNE plot
p1 = plotDR(idc, dimred = "TSNE", colour = qv, alpha = 0.75) +
  scale_colour_viridis_c(option = "F") +
  labs(x = "TSNE1", y = "TSNE2") +
  theme(legend.position = "bottom")
# spatial plot
...
```{r}
# t-SNE plot
p1 = plotDR(idc, dimred = "TSNE", colour = overlaps_nucleus, alpha = 0.75) +
  scale_colour_viridis_c(option = "F") +
  labs(x = "TSNE1", y = "TSNE2") +
  theme(legend.position = "bottom")
# spatial plot
...
# t-SNE plot
p1 = plotDR(idc, dimred = "TSNE", colour = keep, alpha = 0.75) +
...
![SpaNorm schematic](https://github.com/bhuvad/SpaNorm/blob/master/vignettes/SpaNormWorkflow.png)
